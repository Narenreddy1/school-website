      ...
      <section className="bg-primary py-20 text-white text-center relative overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-4 relative z-10">
          ...
          <p className="text-xl text-blue-100 max-w-3xl mx-auto">
            A legacy of excellence, a future of innovation. Discover the heart
            of Prateep Memorial School.
          </p>
        </div>
      </section>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            <div>
              ...
              <h3 className="text-4xl font-bold text-gray-900 mb-8">
                1+ Years of Educational Excellence
              </h3>
              <p className="text-lg text-gray-600 mb-6 leading-relaxed">
                Founded in 2025, Prateep Memorial School was established with a
                vision to provide quality education that transcends textbooks.
                We believe in nurturing the unique potential of every child.
              </p>
              <p className="text-lg text-gray-600 mb-8 leading-relaxed">
                In a short span of time, we have grown into a promising
                educational institution, recognized for our academic excellence,
                holistic development programs, and modern digital
                infrastructure.
              </p>
              <div className="grid grid-cols-2 gap-8">
                ...
                <div className="flex items-center gap-4">
                  <div className="bg-green-100 p-3 rounded-xl text-secondary">
                    <Eye size={24} />
                  </div>
                  <div>
            ...
            <div className="relative">
              ...
              <div className="absolute -bottom-10 -left-10 bg-white p-8 rounded-3xl shadow-xl hidden md:block">
                <div className="text-4xl font-bold text-primary mb-1">2025</div>
          ...
          <div className="bg-white rounded-[3rem] p-12 md:p-20 shadow-xl flex flex-col md:flex-row gap-12 items-center">
            ...
            <div>
              ...
              <p className="text-xl text-gray-600 italic mb-8 leading-relaxed">
                "At Prateep Memorial, we don't just teach subjects; we inspire
                curiosity. Our goal is to create a generation of thinkers,
                innovators, and compassionate leaders who are ready to take on
              ...
              <div>
                ...
                <div className="text-primary font-medium">
                  Chairperson, Prateep Memorial School
                </div>
              </div>
            </div>
          </div>
