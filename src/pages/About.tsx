        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            <div>
              ...
              <h3 className="text-4xl font-bold text-gray-900 mb-8">2 Years of Educational Excellence</h3>
              <p className="text-lg text-gray-600 mb-6 leading-relaxed">
                Founded in 2024, Prateep Memorial School was established with a vision to provide quality education that transcends textbooks. We believe in nurturing the unique potential of every child.
              </p>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="bg-white rounded-[3rem] p-12 md:p-20 shadow-xl flex flex-col md:flex-row gap-12 items-center">
            ...
            <div>
              ...
              <h3 className="text-3xl font-bold text-gray-900 mb-6">Message from the Chairperson</h3>
              ...
              <div>
                <div className="font-bold text-xl text-gray-900">Mr. T.S Mithun Kumar</div>
                <div className="text-primary font-medium">Chairperson, Prateep Memorial School</div>
              </div>
            </div>
          </div>
        </div>
      ...
      <section className="py-24">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="space-y-12">
            {[
              { year: '2024', event: 'School Foundation laid with 100 students.' },
