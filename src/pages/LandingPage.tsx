        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex flex-col lg:flex-row items-center gap-16">
          <div className="lg:w-1/2 relative z-10">
            <div className="inline-flex items-center gap-2 bg-blue-100 text-primary px-4 py-2 rounded-full text-sm font-bold mb-6">
              ...
              <span>Leading State Board School</span>
            </div>
            ...
            <p className="text-xl text-gray-600 mb-10 leading-relaxed">
              Prateep Memorial School combines academic excellence with holistic
              development. Secure your child's future with our world-class
              education.
            </p>
            <div className="flex flex-col sm:flex-row gap-4 mb-12">
              <a
                href="#form"
                className="bg-accent text-primary px-10 py-5 rounded-full font-bold text-xl hover:bg-accent-dark transition-all shadow-xl text-center"
              >
                Apply for Admission
              </a>
          ...
          <div className="lg:w-1/2 relative" id="form">
            ...
            <div className="relative bg-white p-10 md:p-16 rounded-[3rem] shadow-2xl border border-gray-100">
              ...
              <p className="text-gray-500 mb-8">
                Get a call back from our admissions counselor.
              </p>
              <form className="space-y-6" onSubmit={handleSubmit}>
                <div>
                  ...
                  <input
                    ...
                    required
                    type="text"
                    className="w-full px-4 py-4 rounded-xl border border-gray-200 focus:ring-2 focus:ring-primary outline-none bg-gray-50"
                ...
                <div>
                  ...
                  <select
                    name="grade"
                    required
                    className="w-full px-4 py-4 rounded-xl border border-gray-200 focus:ring-2 focus:ring-primary outline-none bg-gray-50 appearance-none"
                  >
      ...
      <section className="py-12 bg-gray-50 border-y border-gray-100">
        <div className="max-w-7xl mx-auto px-4 flex flex-wrap justify-center gap-12 opacity-50 grayscale hover:grayscale-0 transition-all">
          <div className="flex items-center gap-2 font-bold text-xl">
            <Shield size={32} /> State Board Affiliated
          </div>
          <div className="flex items-center gap-2 font-bold text-xl">
            <Trophy size={32} /> Award Winning
          </div>
          <div className="flex items-center gap-2 font-bold text-xl">
            <Users size={32} /> 1000+ Students
          </div>
          <div className="flex items-center gap-2 font-bold text-xl">
            <Star size={32} /> 4.9/5 Rating
          </div>
        </div>
      </section>
