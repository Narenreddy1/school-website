  ...
  return (
    <div className="pt-20">
            ...
            <div className="lg:col-span-1 space-y-8">
              <div className="bg-white p-8 rounded-3xl shadow-sm border border-gray-100">
                <div className="flex items-start gap-4">
                  <div className="bg-blue-100 p-3 rounded-2xl text-primary">
                    <MapPin size={24} />
                  </div>
                  <div>
              ...
              <div className="bg-white p-8 rounded-3xl shadow-sm border border-gray-100">
                <div className="flex items-start gap-4">
                  <div className="bg-green-100 p-3 rounded-2xl text-secondary">
                    <Phone size={24} />
                  </div>
                  <div>
                    <h4 className="font-bold text-gray-900 mb-2">
              ...
              <div className="bg-white p-8 rounded-3xl shadow-sm border border-gray-100">
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">pms.gkd@gmail.com</p>
                    <p className="text-gray-600">pms.ho.gkd@gmail.com</p>
                  </div>
                </div>
              </div>
      ...
      <section className="h-[500px] w-full bg-gray-200 relative">
        <iframe
          src="https://www.google.com/maps/embed?pb=!1m17!1m12!1m3!1d3874.913027090778!2d78.5857861758654!3d13.784116296542946!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m2!1m1!2zMTPCsDQ3JzAyLjgiTiA3OMKwMzUnMTguMSJF!5e0!3m2!1sen!2sin!4v1775382824639!5m2!1sen!2sin"
          width="100%"
          height="100%"
          style={{ border: 0 }}
          allowFullScreen
