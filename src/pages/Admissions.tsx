      ...
      <section className="bg-primary py-20 text-white text-center relative overflow-hidden">
        <div className="max-w-7xl mx-auto px-4 relative z-10">
          ...
          <p className="text-xl text-blue-100 max-w-3xl mx-auto">
            Join the Prateep Memorial family. We are now accepting applications for the upcoming academic year.
          </p>
        </div>
      </section>
      ...
      <section className="py-24">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2 className="text-blue-600 font-bold tracking-widest uppercase text-sm mb-4">Step-by-Step</h2>
            <h3 className="text-4xl font-bold text-gray-900">Our Admission Process</h3>
          </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16">
            ...
            <div>
                ...
                <ul className="space-y-4">
                  {[
                    ...
                    <li key={i} className="flex items-start gap-3 text-gray-600">
                      <div className="mt-1 text-primary"><CheckCircle size={18} /></div>
                      {item}
                    </li>
                  ))}
                </ul>
              ...
              <div className="bg-white p-10 rounded-[2rem] shadow-sm border border-gray-100">
                <h3 className="text-2xl font-bold mb-6 text-gray-900">Documents Required</h3>
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                  {[
                    ...
                    <div key={i} className="flex items-center gap-3 p-3 bg-gray-50 rounded-xl text-sm font-medium text-gray-700">
            ...
            <div className="bg-white p-10 md:p-16 rounded-[3rem] shadow-2xl border border-gray-100">
              <h3 className="text-3xl font-bold mb-2 text-gray-900">Apply Online</h3>
              <p className="text-gray-500 mb-8">Fill the form below to start your application.</p>
              
              <form className="space-y-6" onSubmit={handleSubmit}>
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
                  <div>
                    <label className="block text-sm font-bold text-gray-700 mb-2">Student's Name</label>
                    <input name="studentName" required type="text" className="w-full px-4 py-3 rounded-xl border border-gray-200 focus:ring-2 focus:ring-primary outline-none" placeholder="Full Name" />
                  </div>
                  <div>
                    <label className="block text-sm font-bold text-gray-700 mb-2">Date of Birth</label>
                    <input name="dob" required type="date" className="w-full px-4 py-3 rounded-xl border border-gray-200 focus:ring-2 focus:ring-primary outline-none" />
                  </div>
                </div>
                <div>
                  <label className="block text-sm font-bold text-gray-700 mb-2">Applying for Grade</label>
                  <select name="grade" required className="w-full px-4 py-3 rounded-xl border border-gray-200 focus:ring-2 focus:ring-primary outline-none appearance-none bg-white">
                ...
                >
                  {isSubmitting ? 'Submitting...' : isSuccess ? 'Application Sent!' : 'Submit Application'} <ArrowRight size={20} />
                </button>
                {isSuccess && (
                ...
                <p className="text-center text-xs text-gray-400">
                  Our team will contact you within 24 hours to schedule an interaction.
                </p>
              </form>
            </div>
          </div>
