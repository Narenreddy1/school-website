      ...
      <section className="bg-primary py-20 text-white text-center relative overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-4 relative z-10">
          ...
          <p className="text-xl text-blue-100 max-w-3xl mx-auto">
            Empowering students with a future-ready curriculum and innovative
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center mb-24">
            <div>
              ...
              <h3 className="text-4xl font-bold text-gray-900 mb-8">
                State Based Holistic Learning
              </h3>
              <p className="text-lg text-gray-600 mb-6 leading-relaxed">
                Our curriculum is designed to foster critical thinking,
                creativity, and a love for learning. We follow the State
                framework, enhanced with international best practices.
              </p>
          ...
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              We move beyond rote memorization to experiential and inquiry-based
              learning.
            </p>
          </div>
            ...
            {[
              {
                ...
                desc: "Learning by doing through projects, field trips, and hands-on experiments.",
                icon: Lightbulb,
                color: "bg-yellow-100 text-yellow-600",
              },
              {
                title: "Digital Integration",
                desc: "Seamless use of technology and digital resources in every subject.",
                icon: Laptop,
                color: "bg-blue-100 text-blue-600",
              },
              {
                title: "Collaborative Work",
                desc: "Group projects and peer learning to build teamwork and social skills.",
                icon: Users,
              ...
              >
                <div
                  className={`${item.color} w-16 h-16 rounded-2xl flex items-center justify-center mb-8`}
                >
                  <item.icon size={32} />
                </div>
          ...
          <div className="bg-primary rounded-[3rem] p-12 md:p-20 text-white flex flex-col lg:flex-row gap-16 items-center">
            <div className="lg:w-1/2">
              ...
              <p className="text-xl text-blue-100 mb-8 leading-relaxed">
                We believe in evaluating a child's progress across various
                dimensions, not just exams. Our assessment system is designed to
                be stress-free and growth-oriented.
              </p>
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
                ...
                <div className="bg-white/10 p-6 rounded-2xl border border-white/10">
                  ...
                  <p className="text-sm text-blue-50">
                    Term-end evaluations to measure overall understanding.
                  </p>
                </div>
              </div>
            </div>
